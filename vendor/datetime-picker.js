...
angular
    ...
    .controller('DateTimePickerController', [
        ...
        function (
            ...
            this.init = function (_ngModel, $locale) {
                ngModel = _ngModel;
                ngModelOptions =
                    ngModel.$options || uiDatetimePickerConfig.ngModelOptions;
                ...
                scope.initialPicker = angular.isDefined(attrs.initialPicker)
                    ? attrs.initialPicker
                    : scope.enableDate
                        ? uiDatetimePickerConfig.initialPicker
                        : 'time';
                ...
                // default picker view
                scope.showPicker = !scope.enableDate
                    ? 'time'
                    : scope.initialPicker;
                ...
                if (uiDatetimePickerConfig.html5Types[attrs.type]) {
                    ...
                    attrs.$observe('datetimePicker', function (value) {
                        var newDateFormat =
                            value || uiDatetimePickerConfig.dateFormat;
                ...
                if (attrs.datepickerOptions) {
                    ...
                    if (options && options.initDate) {
                        scope.initDate = uibDateParser.fromTimezone(
                            options.initDate,
                ...
                angular.forEach(
                    ...
                    function (key) {
                        if (attrs[key]) {
                            ...
                            watchListeners.push(
                                scope.$parent.$watch(getAttribute, function (
                                    value
                                ) {
                            ...
                            if (key === 'datepickerMode') {
                                ...
                                watchListeners.push(
                                    scope.$watch('watchData.' + key, function (
                                        value,
                                        oldvalue
                                    ) {
                                        if (
                ...
                angular.forEach(['minDate', 'maxDate', 'initDate'], function (
                    key
                ) {
                    if (attrs[key]) {
                        var getAttribute = $parse(attrs[key]);
                ...
                if (!isHtml5DateInput) {
                    ...
                    ngModel.$formatters.push(function (value) {
                        ...
                        scope.date = uibDateParser.fromTimezone(
                            value,
                            ngModelOptions.timezone
                        );
            ...
            scope.doShow = function (key) {
                ...
                else return uiDatetimePickerConfig.buttonBar[key].show;
            };
            ...
            scope.$watch('isOpen', function (value) {
                ...
                if (value) {
                    ...
                    var position = appendToBody
                        ? $uibPosition.offset(element)
                        : $uibPosition.position(element);

                    if (appendToBody) {
                        scope.dropdownStyle.top =
                            position.top + element.prop('offsetHeight') + 'px';
                    } else {
            ...
            scope.isDisabled = function (date) {
                ...
                return (
                    (scope.watchData.minDate &&
                        scope.compare(date, scope.watchData.minDate) < 0) ||
                    (scope.watchData.maxDate &&
                        scope.compare(date, scope.watchData.maxDate) > 0)
                );
            };
            ...
            function documentClickBind(evt) {
                ...
                var popupContainsTarget =
                    popup.contains !== undefined && popup.contains(evt.target);
            ...
            function parseDate(viewValue) {
                ...
                if (!viewValue) {
                    ...
                    if (!isNaN(date)) {
                        return uibDateParser.toTimezone(
                            date,
                            ngModelOptions.timezone
                        );
                    }
